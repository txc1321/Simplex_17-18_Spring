...
void Application::InitVariables(void)
{
	...
	// Add entitys to manager
	manager->AddEntity("Minecraft\\Creeper.obj", "Creeper");
	manager->AddEntity("Minecraft\\Steve.obj", "Steve");
...
void Application::Update(void)
{
	...
	manager->GetEntity("Creeper")->SetModelMatrix(mCreeper);
	...
	manager->GetEntity("Steve")->SetModelMatrix(mSteve);
	...
	manager->GetEntity("Cow")->SetModelMatrix(mCow);
	manager->GetEntity("Pig")->SetModelMatrix(mPig);
	manager->GetEntity("Zombie")->SetModelMatrix(mZombie);

	//Check collision
	//bool bColliding = m_pCreeper->IsColliding(m_pSteve);
	bool bColliding = manager->GetEntity("Creeper")->IsColliding(manager->GetEntity("Steve"));
	...
	manager->GetEntity("Creeper")->AddToRenderList(true);
	manager->GetEntity("Steve")->AddToRenderList(true);
