...
void MyMesh::GenerateCube() 
{
	std::vector<vector3> lPositions;
	lPositions.push_back(vector3(0, 0, 0)); //0
	lPositions.push_back(vector3(5, 0, 0)); //1
	lPositions.push_back(vector3(5, 5, 0)); //2
	lPositions.push_back(vector3(0, 5, 0)); //3

	lPositions.push_back(vector3(0, 0, -5)); //4
	lPositions.push_back(vector3(5, 0, -5)); //5
	lPositions.push_back(vector3(5, 5, -5)); //6
	lPositions.push_back(vector3(0, 5, -5)); //7

	AddVertexPosition(lPositions[0]);
	AddVertexPosition(lPositions[1]);
	AddVertexPosition(lPositions[2]);

	AddVertexPosition(lPositions[0]);
	AddVertexPosition(lPositions[2]);
	AddVertexPosition(lPositions[3]);


	AddVertexPosition(lPositions[4]);
	AddVertexPosition(lPositions[6]);
	AddVertexPosition(lPositions[5]);

	AddVertexPosition(lPositions[4]);
	AddVertexPosition(lPositions[7]);
	AddVertexPosition(lPositions[6]);

	AddVertexColor(vector3(1.0, 0.0, 0.0));
	AddVertexColor(C_GREEN);
	AddVertexColor(C_BLUE);
